...
?>    
   <div class="col-lg-4 col-md-6 mb-4" style="max-height:500px;overflow:hidden;position:relative;">
		<div class="card h-100">
			...
			<div class="card-body">
				<h4 class="card-title">
					<a href="<?php echo $this->config->base_url(); ?>kontrakkan/product?id=<?php echo $key['id_hunian'] ?>"><?php echo $key['nama_hunian'] ?></a>
				</h4>
			...
			<div class="card-footer" style="padding:0;position:absolute;bottom:0;left:0;width:100%;z-index:1;">
				<a href='<?php echo $this->config->base_url(); ?>kontrakkan/product?id=<?php echo $key['id_hunian'] ?>'><button type="button" class="btn btn-primary btn-block">Beli!!!</button></a>
			</div>
		</div>
	</div> 
<?php  
