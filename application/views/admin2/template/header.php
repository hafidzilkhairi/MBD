						...
						<ul class="nofitications-dropdown">
							<li class="dropdown head-dpdn">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									...
									<span class="badge">
										<?php echo $this->db->get('pesanuser')->num_rows(); ?>
									</span>
								</a>
								<ul class="dropdown-menu">
									<li>
										<div class="notification_header">
											<h3>You have
												<?php echo $jumPesan ?> new messages</h3>
										</div>
									</li>
									<!-- <li>
									<a href="#">
							...
							<li class="dropdown head-dpdn">
								...
								<ul class="dropdown-menu">
									<li>
										<div class="notification_header">
											<h3>You have
												<?php echo $jumPesanan ?> new notification</h3>
										</div>
										<!-- </li>
								<li>
									<a href="#">
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">
										...
										<div class="user-name">
											<p>
												<?php $this->db->where('id_user',(int) $_SESSION['userAdminId']); echo $this->db->get('user','username_user')->result_array()[0]['username_user']; ?>
											</p>
