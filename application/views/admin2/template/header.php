	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span> Kuriak<span class="dashboard_text">Admin dashboard</span></a></h1>
          </div>
					...
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">
								   <div class="user_img"><img src="<?php echo $this->config->base_url(); ?>resource/admin/images/1.jpg" alt=""></div>
								...
								<li class="odd"><a href="#">
									<div class="user_img"><img src="<?php echo $this->config->base_url(); ?>resource/admin/images/4.jpg" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="<?php echo $this->config->base_url(); ?>resource/admin/images/3.jpg" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="<?php echo $this->config->base_url(); ?>resource/admin/images/2.jpg" alt=""> </span> 
									<div class="user-name">
										<p>Admin Name</p>
