<?php
if($this->session->flashdata('hapusgambarbarang')=='sukses'){
?>
<script>
	alert('Hapus Gambar Barang Sukses');

</script>
<?php
}else if($this->session->flashdata('hapusgambarbarang')=='gagal'){
?>
	<script>
		alert('Hapus Gambar Barang Gagal');

	</script>
	<?php
}
?>
				<h1 style="padding: 40px 0;" class="text-center">Gambar Barang Management</h1>
            ...
            echo "<tr>";
                ?>
						...
						<td>
							<a href="<?php echo $this->config->base_url(); ?>admin2/hapusgambarbarang?id=<?php echo $key['id_gambar']; ?>">
