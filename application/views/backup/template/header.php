				...
				<div class=" h_menu4">
					<ul class="memenu skyblue">
						...
						<?php if(isset($_SESSION['userId'])){
							?>
						<li>
							<a href='#'><i class="fa fa-user"></i><?php $this->db->where('id_user',$_SESSION['userId']); echo $this->db->get('user','username_user')->result_array()[0]['username_user']; ?></a>
							<div class="mepanel">
								<a style='display:block;'href="<?php echo $this->config->base_url();?>/logout">Logout</a>
							</div>
						</li>
							<?php
						}else{
							?>
							<li><a class="color4" href="<?php echo $this->config->base_url()?>login">Login</a></li>
							<?php
						}
						?>
					</ul>
